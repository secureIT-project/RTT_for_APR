...
class Translator:
    def __init__(self, model_path, BPE_path):
        ...
        encoder, decoder = build_model(self.reloaded_params, self.dico, gpu=False)
...
def returned_translation(model_path, program_input, src_lang, tgt_lang, beam_size, BPE_path = None):
